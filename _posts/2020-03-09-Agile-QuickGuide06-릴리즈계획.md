...
보통 Release라 함은 S/W 프로그램의 출시를 의미하며, 스크럼 프레임워크에서 Release Plan은 고객이 사용하는 시장환경 또는 Production 환경으로의 출시 기능 및 일정에 대한 계획 수립을  말한다. 
Release할 대상 기능은 고객가치 / 전반적인 품질 / 범위 / 일정 / 예산 사이에서 균형을 이루어 결정하도록 한다. 제품 출시는 시장 상황이나 TTM(Time-To-Market)을 고려하여 수차례에 걸쳐 이루어질 수도 있다.
